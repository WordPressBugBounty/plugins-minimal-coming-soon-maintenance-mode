...
(function ($) {
  ...
  $('#weglot-upsell-dialog').dialog({'dialogClass': 'wp-dialog weglot-upsell-dialog',
                              'modal': 1,
                              'resizable': false,
                              'title': 'Translate your coming soon page to any language',
                              'zIndex': 9999,
                              'width': 550,
                              'height': 'auto',
                              'show': 'fade',
                              ...
                              'open': function(event, ui) {
                                ...
                                $(this).siblings().find('span.ui-dialog-title').html(mm_js_vars.weglot_dialog_upsell_title);
                              },
