...
<form role="form" method="post" class="signals-admin-form">
    <div class="signals-body signals-clearfix">
        ...
        if (
            ...
            echo 'Minimal Coming Soon &amp; Maintenance Mode PRO features over 450 themes, advanced SEO options, content animations, Instagram filters, animated backgrounds and premium support.';
